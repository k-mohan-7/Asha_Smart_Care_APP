...
public class SyncPendingAdapter extends RecyclerView.Adapter<SyncPendingAdapter.ViewHolder> {
    ...
    public SyncPendingAdapter(Context context, List<SyncRecord> recordList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_sync_pending, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvType.setText("Record ID: " + record.getRecordId());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvName, tvType, tvTimestamp;
